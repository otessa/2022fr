...
date: "dernière mise à jour `r format(Sys.time(), '%A, %b %d, %H:%M %p, %Z')`"
...
[![Friends of OTESSA](assets/media/friends.png)](https://otessa.org/fr/sponsors){target="_blank"}
...
Click the menu to toggle open or close the table of contents.
